...
**
** Created: Sat Apr 16 18:34:18 2011
...
static const char qt_meta_stringdata_CustomSlider[] = {
    "CustomSlider\0\0firstFrame\0setFirstFrame(int)\0"
    "lastFrame\0setLastFrame(int)\0int\0"
};

const QMetaObject CustomSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_CustomSlider,
      qt_meta_data_CustomSlider, 0 }
};
...
int CustomSlider::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: setFirstFrame((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: setLastFrame((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = firstFrame(); break;
        case 1: *reinterpret_cast< int*>(_v) = lastFrame(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setFirstFrame(*reinterpret_cast< int*>(_v)); break;
        case 1: setLastFrame(*reinterpret_cast< int*>(_v)); break;
        }
        _id -= 2;
